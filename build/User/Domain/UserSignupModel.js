...
var UserSignupModel = /** @class */ (function () {
    function UserSignupModel(userReq) {
    ...
    UserSignupModel.prototype.isValid = function () {
        if (this._username.length < 6)
            return false;
        if (this._password.length < 6)
            return false;
        return this.emailRegex.test(this._email);
    };
    Object.defineProperty(UserSignupModel.prototype, "username", {
        get: function () {
    ...
    Object.defineProperty(UserSignupModel.prototype, "password", {
        get: function () {
    ...
    Object.defineProperty(UserSignupModel.prototype, "email", {
        get: function () {
            return this._email;
        },
        set: function (value) {
