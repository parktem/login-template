...
var UserSigninModel = /** @class */ (function () {
    function UserSigninModel(userReq) {
    ...
    UserSigninModel.prototype.isValid = function () {
        if (this._password.length < 6)
            return false;
        return this.emailRegex.test(this._email);
    };
    Object.defineProperty(UserSigninModel.prototype, "password", {
        get: function () {
    ...
    Object.defineProperty(UserSigninModel.prototype, "email", {
        get: function () {
            return this._email;
        },
        set: function (value) {
